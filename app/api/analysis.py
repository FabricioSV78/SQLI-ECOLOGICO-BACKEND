    ...
    try:
        ...
        try:
            ...
            if project_id.isdigit():
                proyecto_obj = db.query(Proyecto).filter(Proyecto.id == int(project_id), Proyecto.usuario_id == current_user.id).first()
            else:
                proyecto_obj = db.query(Proyecto).filter(Proyecto.nombre == project_id, Proyecto.usuario_id == current_user.id).first()
