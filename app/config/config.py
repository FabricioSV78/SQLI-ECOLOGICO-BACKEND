...
class Settings:
    ...
    DB_PASS: str = os.getenv("DB_PASS", "jbkbQuRoHqmDdhCGnbewWWwIlYMkdVOy")
    DB_HOST: str = os.getenv("DB_HOST", "switchyard.proxy.rlwy.net")
    DB_PORT: str = os.getenv("DB_PORT", "18791")
